...
export default function ServiceProviderPage() {
    ...
    const serviceProviders = [
        ...
        },
        {
            ...
            service: "Gardening",
            rating: 4.6,
            image: "/trusted_local_gardeners_gardening_service.jpg.600x370_q85_crop-smart_upscale.jpg",
        },
    ];
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-white">
                            {serviceProviders.map((provider, index) => (
                                <PinContainer key={index}
                                    ...
                                    href="./profile"
                                >
                                    <div key={provider.id} className="bg-white w-80 border overflow-hidden text-black">
                    ...
                    <div className="container mx-auto px-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div>
                                ...
                                <p className="text-sm">Discover and get the best service providers in your area.</p>
                            </div>
                            <div>
                                <h3 className="text-lg font-semibold mb-4">For Service provi  ders</h3>
