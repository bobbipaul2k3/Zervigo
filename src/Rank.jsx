...
function ProfileCard({ profile, isTopThree }) {
  return (
    ...
    <div className={`bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 ${isTopThree ? 'col-span-2' : 'col-span-1'}`}>
      ...
      <div className="p-4">
        <div className="flex items-center mb-2">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">{profile.services.join(", ")}</p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-green-600 font-bold">${profile.startingPrice}</span>
        </div>
      </div>
...
export default function ProfileDisplay() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-to-r from-teal-400 to-blue-400">
      <h1 className="text-3xl font-bold text-center mb-12 text-white font-serif ">TOP RATED</h1>
      ...
      <h2 className="text-2xl font-bold text-center mb-8 font-serif text-white">OTHERS</h2>
